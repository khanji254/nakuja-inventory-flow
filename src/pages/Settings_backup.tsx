...
// Simple local config manager
const defaultConfig: SystemConfig = {
  categories: ['Electronics', 'Materials', 'Tools', 'Chemicals', 'Safety Equipment', 'Office Supplies'],
  locations: ['Lab A', 'Lab B', 'Storage Room', 'Warehouse', 'Clean Room', 'Workshop'],
  defaultSettings: {
  ...
  teams: ['Avionics', 'Telemetry', 'Parachute', 'Recovery'],
  userRoles: ['admin', 'team-lead', 'team-member']
};
...
export default function Settings() {
  ...
  const [categories, setCategories] = useState<string[]>(defaultConfig.categories)
  const [locations, setLocations] = useState<string[]>(defaultConfig.locations)
  const [teams, setTeams] = useState<string[]>(defaultConfig.teams)
